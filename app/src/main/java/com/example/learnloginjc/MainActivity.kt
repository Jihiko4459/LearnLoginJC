...
fun LoginScreen(onLoginSuccess:()->Unit){
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(value = password, onValueChange = {password=it},
            ...
            shape = RoundedCornerShape(20.dp),//закругление
            colors = TextFieldDefaults.colors(
                focusedLeadingIconColor = GreenJC,
                unfocusedLeadingIconColor = GreenJC,
                focusedLabelColor = GreenJC,
            ...
            modifier = Modifier
                .fillMaxWidth()
                .padding(bottom = 8.dp),
            visualTransformation = PasswordVisualTransformation()//***** для пароля
        )
        Button(onClick = {
...
private fun authenticate(username:String, password:String):Boolean{
    val validUsername="admin"//верное имя пользователя
    val validPassword="admin123"//верный пароль
